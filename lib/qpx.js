...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashObjectDefaultsDeep = __webpack_require__(29);

	var _lodashObjectDefaultsDeep2 = _interopRequireDefault(_lodashObjectDefaultsDeep);

	var _lodashLangClone = __webpack_require__(43);

	var _lodashLangClone2 = _interopRequireDefault(_lodashLangClone);

	var _keymirror = __webpack_require__(50);
	...
	var _requestPassengers = __webpack_require__(53);

	var _requestPassengers2 = _interopRequireDefault(_requestPassengers);

	var _requestFare = __webpack_require__(54);

	var _requestFare2 = _interopRequireDefault(_requestFare);

	var _requestCountry = __webpack_require__(55);

	var _requestCountry2 = _interopRequireDefault(_requestCountry);

	var _requestPrice = __webpack_require__(56);

	var _requestPrice2 = _interopRequireDefault(_requestPrice);

	var _requestRefundable = __webpack_require__(57);

	var _requestRefundable2 = _interopRequireDefault(_requestRefundable);
	...
	exports['default'] = function (key) {
	  var appKey = key;
	  var fields = {
	    passengers: (0, _requestPassengers2['default'])(),
	    fare: (0, _requestFare2['default'])(),
	    country: (0, _requestCountry2['default'])(),
	    price: (0, _requestPrice2['default'])(),
	    refundable: (0, _requestRefundable2['default'])()
	  };

	  return {
	    fields: fields,
	    search: function search() {
	      var customRequest = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	      var customOptions = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

	      var url = URL + '?key=' + appKey;
	      var request = _generateRequest(customRequest, fields);
	...
	function _search(url, request, customOptions) {
	  return (0, _isomorphicFetch2['default'])(url, (0, _lodashObjectDefaults2['default'])(customOptions, {
	    method: 'POST',
	    credentials: 'include',
	    headers: {
	...
	function _generateRequest(customRequest, qpx) {
	  return (0, _lodashObjectDefaults2['default'])(customRequest, {
	    passengers: qpx.passengers.getPassengers(),
	    slice: [qpx.fare.getFare()],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createDefaults = __webpack_require__(28),
	    merge = __webpack_require__(30),
	    mergeDefaults = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayEach = __webpack_require__(32),
	    baseMergeDeep = __webpack_require__(33),
	    isArray = __webpack_require__(17),
	    isArrayLike = __webpack_require__(11),
	    isObject = __webpack_require__(9),
	    isObjectLike = __webpack_require__(10),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayCopy = __webpack_require__(34),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseForIn = __webpack_require__(36),
	    isArguments = __webpack_require__(16),
	    isObjectLike = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function passengers() {
	  var customDefaults = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

	  var passengers = (0, _lodashObjectDefaults2['default'])(customDefaults, {
	    adultCount: 0,
	    childCount: 0,
	    infantInLapCount: 0,
	    infantInSeatCount: 0,
	  ...
	  return {
	    ...
	    infantsInLap: function infantsInLap(i) {
	      passengers.infantInLapCount = i;
	      return this;
	    },
	    infantsInSeat: function infantsInSeat(i) {
	      passengers.infantInSeatCount = i;
	      return this;
	    },
	    seniors: function seniors(s) {
	      passengers.seniorCount = s;
	      return this;
	    },
	    getPassengers: function getPassengers() {
	      return (0, _lodashLangClone2['default'])(passengers);
	    }
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CABIN = (0, _keymirror2['default'])({
	  COACH: 0,
	  PREMIUM_COACH: 0,
	  BUSINESS: 0,
	  FIRST: 0
	...
	function fare() {
	  var defaultsOverride = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

	  var fare = (0, _lodashObjectDefaults2['default'])(defaultsOverride, {
	  ...
	  return {
	    ...
	    maxStops: function maxStops(s) {
	      fare.maxStops = s;
	      return this;
	    },
	    maxConnectionDuration: function maxConnectionDuration(c) {
	      fare.maxConnectionDuration = c;
	      return this;
	    },
	    cabin: function cabin(c) {
	      fare.preferredCabin = c;
	      return this;
	    },
	    withCarriers: function withCarriers(c) {
	      fare.permittedCarrier = fare.permittedCarrier.concat(c);
	      return this;
	    },
	    avoidCarriers: function avoidCarriers(c) {
	      fare.prohibitedCarrier = fare.prohibitedCarrier.concat(c);
	      return this;
	    },
	    getFare: function getFare() {
	      return (0, _lodashLangClone2['default'])(fare);
	    }
	  };
	}
...
/***/ function(module, exports) {
	...
	function country() {
	  var customDefault = arguments.length <= 0 || arguments[0] === undefined ? 'GB' : arguments[0];

	  var country = customDefault;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function price() {
	  ...
	  var price = (0, _lodashObjectDefaults2['default'])(customDefaults, {
	    amount: 0,
	    currency: 'GBP'
	  });
...
/***/ function(module, exports) {
	...
	exports["default"] = refundable;

	function refundable() {
	  var customDefault = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];

	  var refundable = customDefault;
	  ...
	  return {
	    ...
	    getRefundable: function getRefundable() {
	      return refundable;
	    }
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(59), __webpack_require__(60).setImmediate, (function() { return this; }()), __webpack_require__(61)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qpx = __webpack_require__(1);

	var _qpx2 = _interopRequireDefault(_qpx);

	var API_KEY = 'AIzaSyB59RHC-_jzeUwX9eb5_T2UT4t5XG21ujc';
	var q = (0, _qpx2['default'])(API_KEY);
	q.fields.passengers.adults(1);
	q.fields.fare.from("LHR").to("CDG").on("2015-08-08").after('18:00').before('23:59');
